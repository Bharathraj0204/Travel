...
import pine from './Travelimages/pine.jpg'
import pillar from './Travelimages/pillar.webp'
import poombarai from './Travelimages/poombarai.jpg'
import guna from './Travelimages/guna.webp'
import { useNavigate } from 'react-router-dom'
export default function Kodai() {
...
{popup && 
     <div>
      ...
      <fieldset>
        ...
        <div className='card'>
            <div class="image-box">
                <img src={pine} alt='pine-forest-img'/>
            </div> 
            ...
            <div className='card'>
            <div class="image-box">
            <img src={pillar} alt='pillar-rocks-img'/>
            </div> 
            <div className='content'>
            <h2>Pillar Rock</h2>
        ...
        <div className='kodai-page'>
            <div className='card'>
            <div class="image-box">
            <img src={poombarai} alt='poombarai-village-view-img'/>
            </div> 
            <div className='content'>
            <h2>Poombarai Vollage</h2>
            ...
            <div className='card'>
            <div class="image-box">
            <img src={guna} alt='guna-caves-img'/>
            </div> 
            <div className='content'>
            <h2>Guna Cave</h2>
