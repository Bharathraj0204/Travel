...
import dolphin from '../TravelBooking/Travelimages/dolphin.jpeg'
import doddabetta from '../TravelBooking/Travelimages/doddabetta.jpg'
import tiger from '../TravelBooking/Travelimages/tiger.webp'
import boat from '../TravelBooking/Travelimages/boat.jpeg'
// import botanical from '../TravelBooking/Travelimages/botanical.jpeg'
...
{popup && 
     <div>
      ...
      <fieldset>
            <legend><h2>Places to visit in Ooty</h2></legend>
        ...
        <div className='card'>
            <div class="image-box">
                <img src={dolphin} alt='pine-forest-img'/>
            </div> 
            ...
            <div className='card'>
            <div class="image-box">
            <img src={doddabetta} alt='pillar-rocks-img'/>
            </div> 
            <div className='content'>
            <h2>Doddabetta</h2>
        ...
        <div className='kodai-page'>
            <div className='card'>
            <div class="image-box">
            <img src={tiger} alt='poombarai-village-view-img'/>
            </div> 
            <div className='content'>
            <h2>Tiger</h2>
            ...
            <div className='card'>
            <div class="image-box">
            <img src={boat} alt='guna-caves-img'/>
            </div> 
            <div className='content'>
            <h2>Boat</h2>
